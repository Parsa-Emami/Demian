 ...
 * public/assets/characters/ronak/manifests/ronak_future_manifest.json).
 *
 * Ronak is a Legacy Character: production_status =
 ...
 * still call it by name; it intentionally does not activate Ronak and
 * must not be reintroduced as the active/default character. Ronak
