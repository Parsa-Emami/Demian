 ...
 * public/assets/characters/iman/manifests/iman_future_manifest.json).
 *
 * Iman is a Legacy Character: production_status =
 ...
 * still call it by name; it intentionally does not activate Iman and
 * must not be reintroduced as the active/default character. Iman
