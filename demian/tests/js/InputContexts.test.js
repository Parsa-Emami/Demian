...
test('Open World preserves all current character action names', () => {
    const requiredActions = [
        'run', 'jump', 'attack', 'combo', 'uppercut', 'cast', 'charge', 'hurt',
        'win', 'celebrate', 'dash', 'slide', 'dodge', 'dance', 'wave', 'salute',
