...
test('V6 is the canonical built-in character pack and rejects combat animation names', () => {
    ...
    assert.equal(characterPackVersion('darya'), 8);
    ...
    assert.match(darya.spriteUrl, /darya-spritesheet-v8-mobile\.png$/);
    assert.match(darya.atlasUrl, /darya-atlas-v8-mobile\.json$/);
